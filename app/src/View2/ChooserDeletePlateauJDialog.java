 ...
 * @author Léa Berne
 */
public class ChooserDeletePlateauJDialog extends javax.swing.JDialog {
     ...
     */
    public ChooserDeletePlateauJDialog(java.awt.Frame parent, boolean modal, IApp iApp) {
        super(parent, modal);
        this.iApp = iApp;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        choosePlateauToDeleteJComboBox1 = new javax.swing.JComboBox<Plateau>();
        ...
        creationPlateauJLabel.setText("Suppression des plateaux standards");
        ...
        nomPlateauJLabel1.setText("Choisisez le plateau à supprimer :");
        ...
        for (Plateau plateau : plateaux){
            deletePlateauCBBModel.addElement(plateau);
        }
        choosePlateauToDeleteJComboBox1.setModel(deletePlateauCBBModel);
        centrePlateauxJPanel.add(choosePlateauToDeleteJComboBox1, new java.awt.GridBagConstraints());
    ...
    private void okJButtonActionPerformed(java.awt.event.ActionEvent evt) {                                          
        Plateau plateauSelectionne = (Plateau) this.choosePlateauToDeleteJComboBox1.getSelectedItem();
        int result = JOptionPane.showConfirmDialog(rootPane, "Etes-vous sûr de vouloir supprimer " + plateauSelectionne.getNomPlateau(), "Confirmez", JOptionPane.YES_NO_OPTION);
    ...
    private javax.swing.JComboBox<Plateau> choosePlateauToDeleteJComboBox1;
