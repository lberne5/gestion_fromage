 ...
 * @author Léa Berne
 */
public class ChooserEditCommandeJDialog1 extends javax.swing.JDialog {
     ...
     */
    public ChooserEditCommandeJDialog1(java.awt.Frame parent, boolean modal, IApp iApp) {
        super(parent, modal);
        this.iApp = iApp;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        choosePlateauToEditJComboBox1 = new javax.swing.JComboBox<Commande>();
        ...
        creationPlateauJLabel.setText("Edition des commandes");
        ...
        nomPlateauJLabel1.setText("Choisisez la commande à modifier :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        centrePlateauxJPanel.add(nomPlateauJLabel1, gridBagConstraints);

        DefaultComboBoxModel editCommandeCBBModel = new DefaultComboBoxModel<Commande>();
        ArrayList<Commande> commandes = iApp.toutRecupererCommande();
        for (Commande commande : commandes){
            editCommandeCBBModel.addElement(commande);
        }
        choosePlateauToEditJComboBox1.setModel(editCommandeCBBModel);
    ...
    private void okJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okJButtonActionPerformed
        EditCommandeJDialog editCommandeJDialog = new EditCommandeJDialog((App) this.getOwner(), true, this.iApp, (Commande) this.choosePlateauToEditJComboBox1.getSelectedItem());
        this.dispose();
        editCommandeJDialog.setVisible(true);    }//GEN-LAST:event_okJButtonActionPerformed
    ...
    private javax.swing.JComboBox<Commande> choosePlateauToEditJComboBox1;
