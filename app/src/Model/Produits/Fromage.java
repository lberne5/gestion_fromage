 ...
 * @author Lea Berne
 */
public class Fromage extends Produit implements Quantifiable {

    public Fromage(String nom, double prix, int idProduit) {
        super(nom, prix, idProduit);
        this.unite = Unite.INDEFINIE;
        this.quantiteParPersonnes = 0;
    }

    public Fromage(String nom, double prix, double quantiteParPersonnes, String unite, int idProduit) {
        super(nom, prix, idProduit);
        if (unite != null) {
    ...
    public Fromage(String nom, double prix, double quantiteParPersonnes, Unite unite, int idProduit) {
        super(nom, prix, idProduit);
        if (unite != null) {
            this.unite = unite;
    ...
    public String toString() {
        String res = (this.getNom() + " (Fromage) : " + this.getPrix() + " euros par personnes");
