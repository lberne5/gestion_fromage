 ...
 * @author Lea Berne
 */
public class Charcuterie extends Produit implements Quantifiable {

    public Charcuterie(String nom, double prix, int idProduit) {
        super(nom, prix, idProduit);
        this.unite = Unite.INDEFINIE;
        this.quantiteParPersonnes = 0;
    }

    public Charcuterie(String nom, double prix, double quantiteParPersonnes, String unite, int idProduit) {
        super(nom, prix, idProduit);
        if (unite != null) {
    ...
    public Charcuterie(String nom, double prix, double quantiteParPersonnes, Unite unite, int idProduit) {
        super(nom, prix, idProduit);
        if (unite != null) {
            this.unite = unite;
        } else {
    ...
    public String toString() {
        String res = (this.getNom() + " (Charcuterie) : " + this.getPrix() + " euros par personnes");
